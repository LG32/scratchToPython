...
goog.require = function (a) {
    goog.ENABLE_DEBUG_LOADER && goog.debugLoader_ && goog.getLoader_()
        .earlyProcessLoad(a);
    if (!COMPILED) {
...
goog.bind = function (a, b, c) {
    Function.prototype.bind && -1 != Function.prototype.bind.toString()
        .indexOf('native code') ? goog.bind = goog.bindNative_ : goog.bind = goog.bindJs_;
...
goog.DEPENDENCIES_ENABLED && (goog.inHtmlDocument_ = function () {
    ...
    return a && ('goog' == b.module ||
        this.getTranspiler()
            .needsTranspile(c)) ? goog.basePath + a in this.dependencies_.deferred : !1;
...
goog.string.numberAwareCompare_ = function (a, b, c) {
    ...
    if (!a) return -1;
    if (!b) return 1;
    for (var d = a.toLowerCase()
        .match(c), e = b.toLowerCase()
...
goog.async.run.initializeRunner_ = function () {
    if (-1 != String(goog.global.Promise)
        .indexOf('[native code]')) {
...
goog.fs.url.createObjectUrl = function (a) {
    return goog.fs.url.getUrlObject_()
        .createObjectURL(a);
};
...
goog.i18n.bidi.IS_RTL = goog.i18n.bidi.FORCE_RTL || ('ar' == goog.LOCALE.substring(0, 2)
    .toLowerCase() || 'fa' == goog.LOCALE.substring(0, 2)
    .toLowerCase() || 'he' == goog.LOCALE.substring(0, 2)
    .toLowerCase() || 'iw' == goog.LOCALE.substring(0, 2)
    .toLowerCase() || 'ps' == goog.LOCALE.substring(0, 2)
    .toLowerCase() || 'sd' == goog.LOCALE.substring(0, 2)
    .toLowerCase() || 'ug' == goog.LOCALE.substring(0, 2)
    .toLowerCase() || 'ur' == goog.LOCALE.substring(0, 2)
    .toLowerCase() || 'yi' == goog.LOCALE.substring(0, 2)
    .toLowerCase()) && (2 == goog.LOCALE.length ||
    '-' == goog.LOCALE.substring(2, 3) || '_' == goog.LOCALE.substring(2, 3)) || 3 <= goog.LOCALE.length && 'ckb' == goog.LOCALE.substring(0, 3)
    .toLowerCase() && (3 == goog.LOCALE.length || '-' == goog.LOCALE.substring(3, 4) || '_' == goog.LOCALE.substring(3, 4));
...
goog.i18n.bidi.estimateDirection = function (a, b) {
    for (var c = 0, d = 0, e = !1, f = goog.i18n.bidi.stripHtmlIfNeeded_(a, b)
        .split(goog.i18n.bidi.wordSeparatorRe_), g = 0; g < f.length; g++) {
        var h = f[g];
...
goog.html.TrustedResourceUrl.formatWithParams = function (a, b, c) {
    return goog.html.TrustedResourceUrl.format(a, b)
        .cloneWithParams(c);
};
...
goog.html.SafeStyle.create = function (a) {
    ...
    for (c in a) {
        ...
        var d = a[c];
        null != d && (d = goog.isArray(d) ? goog.array.map(d, goog.html.SafeStyle.sanitizePropertyValue_)
            .join(' ') : goog.html.SafeStyle.sanitizePropertyValue_(d), b += c + ':' + d + ';');
    }
...
goog.html.SafeStyle.sanitizePropertyValue_ = function (a) {
    if (a instanceof goog.html.SafeUrl) {
        return 'url("' + goog.html.SafeUrl.unwrap(a)
            .replace(/</g, '%3c')
            .replace(/[\\"]/g, '\\$&') + '")';
    }
...
goog.html.SafeStyle.sanitizePropertyValueString_ = function (a) {
    var b = a.replace(goog.html.SafeUrl.FUNCTIONS_RE_, '$1')
...
goog.html.SafeStyle.sanitizeUrl_ = function (a) {
    return a.replace(goog.html.SafeUrl.URL_RE_, function (a, c, d, e) {
        ...
        a = goog.html.SafeUrl.sanitize(d)
            .getTypedStringValue();
        return c + b + a + b + e;
    });
};
    ...
    if (c instanceof goog.string.Const) {
        ...
        if (b.toLowerCase() in goog.html.SafeHtml.URL_ATTRIBUTES_) {
            if (c instanceof goog.html.TrustedResourceUrl) {
                ...
                c = goog.html.SafeUrl.sanitize(c)
                    .getTypedStringValue();
            } else {
...
goog.dom.safe.setLinkHrefAndRel = function (a, b, c) {
    ...
    a.rel = c;
    goog.string.caseInsensitiveContains(c, 'stylesheet') ? (goog.asserts.assert(b instanceof goog.html.TrustedResourceUrl, 'URL must be TrustedResourceUrl because "rel" contains "stylesheet"'), a.href = goog.html.TrustedResourceUrl.unwrap(b)) : a.href = b instanceof goog.html.TrustedResourceUrl ? goog.html.TrustedResourceUrl.unwrap(b) : b instanceof goog.html.SafeUrl ? goog.html.SafeUrl.unwrap(b) : goog.html.SafeUrl.sanitizeAssertUnchanged(b)
        .getTypedStringValue();
};
...
goog.dom.getPageScroll = function (a) {
    return goog.dom.getDomHelper((a || goog.global || window).document)
        .getDocumentScroll();
};
...
goog.dom.getTextContent_ = function (a, b, c) {
    if (!(a.nodeName in goog.dom.TAGS_TO_IGNORE_)) {
        if (a.nodeType == goog.dom.NodeType.TEXT) {
            c ? b.push(String(a.nodeValue)
                .replace(/(\r\n|\r|\n)/g, '')) : b.push(a.nodeValue);
        } else if (a.nodeName in goog.dom.PREDEFINED_TAG_VALUES_) b.push(goog.dom.PREDEFINED_TAG_VALUES_[a.nodeName]); else for (a = a.firstChild; a;) goog.dom.getTextContent_(a, b, c), a = a.nextSibling;
    }
};
...
goog.dom.matchesPixelRatio_ = function (a) {
    return goog.dom.getWindow()
        .matchMedia('(min-resolution: ' + a + 'dppx),(min--moz-device-pixel-ratio: ' + a + '),(min-resolution: ' + 96 * a + 'dpi)').matches ? a : 0;
};
...
goog.style.getClientViewportElement = function (a) {
    ...
    return !goog.userAgent.IE || goog.userAgent.isDocumentModeOrHigher(9) || goog.dom.getDomHelper(a)
        .isCss1CompatMode() ? a.documentElement : a.body;
};
...
goog.style.setBorderBoxSize = function (a, b) {
    var c = goog.dom.getOwnerDocument(a), d = goog.dom.getDomHelper(c)
        .isCss1CompatMode();
...
goog.style.getContentBoxSize = function (a) {
    ...
    if (c && goog.dom.getDomHelper(b)
        .isCss1CompatMode() && 'auto' != c.width && 'auto' != c.height && !c.boxSizing) {
...
goog.ui.Control.prototype.enterDocument = function () {
    ...
    if (this.supportedStates_ & ~goog.ui.Component.State.DISABLED && (this.isHandleMouseEvents() && this.enableMouseEventHandling_(!0), this.isSupportedState(goog.ui.Component.State.FOCUSED))) {
        ...
        if (a) {
            ...
            b.attach(a);
            this.getHandler()
                .listen(b, goog.events.KeyHandler.EventType.KEY,
                    this.handleKeyEvent)
...
goog.ui.Control.prototype.handleMouseDown = function (a) {
    this.isEnabled() && (this.isAutoState(goog.ui.Component.State.HOVER) && this.setHighlighted(!0), a.isMouseActionButton() && (this.isAutoState(goog.ui.Component.State.ACTIVE) && this.setActive(!0), this.renderer_ && this.renderer_.isFocusable(this) && this.getKeyEventTarget()
        .focus()));
...
goog.ui.Container.prototype.setKeyEventTarget = function (a) {
    if (this.focusable_) {
        ...
        c && (this.keyEventTarget_ = b, this.enableFocusHandling_(!1), this.keyEventTarget_ = a, this.getKeyHandler()
            .attach(d), this.enableFocusHandling_(!0));
    } else {
...
goog.ui.Container.prototype.enterDocument = function () {
    ...
    this.getHandler()
        ...
        .listen(a, [goog.events.EventType.MOUSEDOWN, goog.events.EventType.MOUSEUP, goog.events.EventType.MOUSEOVER, goog.events.EventType.MOUSEOUT, goog.events.EventType.CONTEXTMENU], this.handleChildMouseEvents);
...
goog.ui.Container.prototype.enableFocusHandling_ = function (a) {
    ...
    a ? b.listen(c, goog.events.EventType.FOCUS, this.handleFocus)
        .listen(c, goog.events.EventType.BLUR, this.handleBlur)
        .listen(this.getKeyHandler(), goog.events.KeyHandler.EventType.KEY, this.handleKeyEvent) : b.unlisten(c, goog.events.EventType.FOCUS, this.handleFocus)
...
goog.ui.Container.prototype.setHighlightedIndex = function (a) {
    (a = this.getChildAt(a)) ? a.setHighlighted(!0) : -1 < this.highlightedIndex_ && this.getHighlighted()
        .setHighlighted(!1);
};
...
goog.ui.MenuItemRenderer.prototype.createDom = function (a) {
    var b = a.getDomHelper()
        .createDom('DIV', this.getClassNames(a)
            .join(' '), this.createContent(a.getContent(), a.getDomHelper()));
...
goog.ui.MenuItemRenderer.prototype.setEnableCheckBoxStructure = function (a, b, c) {
    ...
    c != this.hasCheckBoxStructure(b) && (goog.dom.classlist.enable(b, 'goog-option', c), b = this.getContentElement(b), c ? (c = this.getCompositeCssClass_(goog.ui.MenuItemRenderer.CompositeCssClassIndex_.CHECKBOX), b.insertBefore(a.getDomHelper()
...
goog.ui.Menu.prototype.setVisible = function (a, b, c) {
    (b = goog.ui.Menu.superClass_.setVisible.call(this, a, b)) && a && this.isInDocument() && this.allowAutoFocus_ && this.getKeyEventTarget()
        .focus();
...
goog.ui.Menu.prototype.handleEnterItem = function (a) {
    this.allowAutoFocus_ && this.getKeyEventTarget()
        .focus();
...
goog.ui.Menu.prototype.decorateContent = function (a) {
    ...
    a = this.getDomHelper()
        .getElementsByTagNameAndClass('DIV', b.getCssClass() + '-content', a);
...
goog.ui.PaletteRenderer.prototype.createDom = function (a) {
    ...
    a = a.getDomHelper()
        .createDom('DIV', b, this.createGrid(a.getContent(), a.getSize(), a.getDomHelper()));
...
goog.ui.Palette.prototype.getHighlightedCellElement_ = function () {
    return this.getRenderer()
        .getCellForItem(this.getHighlightedItem());
};
...
goog.ui.Palette.prototype.highlightIndex_ = function (a, b) {
    if (this.getElement()) {
        ...
        if (c && 0 <= a && a < c.length) {
            ...
            this.currentCellControl_.tryHighlight(b) && this.getRenderer()
...
goog.ui.ColorPalette.prototype.createColorNodes = function () {
    return goog.array.map(this.colors_, function (a, b) {
        var c = this.getDomHelper()
            .createDom('DIV', {
                'class': this.getRenderer()
                    .getCssClass() + '-colorswatch', style: 'background-color:' + a
            });
...
goog.ui.tree.BaseNode.prototype.createDom = function () {
    var a = this.getDomHelper()
        .safeHtmlToNode(this.toSafeHtml());
    this.setElementInternal(a);
};
...
goog.ui.tree.BaseNode.prototype.getLastShownDescendant = function () {
    return this.getExpanded() && this.hasChildren() ? this.getLastChild()
        .getLastShownDescendant() : this;
};
...
Blockly.Workspace.prototype.deleteVariable = function (a) {
    for (var b = this.getVariableUses(a), c = 0, d; d = b[c]; c++) {
        if ('procedures_defnoreturn' == d.type || 'procedures_defreturn' == d.type) {
            ...
            Blockly.alert(Blockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE.replace('%1', a)
                .replace('%2', b));
            return;
        }
    }
    var e = this, f = e.getVariable(a);
    1 < b.length ? Blockly.confirm(Blockly.Msg.DELETE_VARIABLE_CONFIRMATION.replace('%1', String(b.length))
        .replace('%2', a), function (a) {
...
Blockly.Bubble = function (a, b, c, d, e, f) {
    ...
    a.getBubbleCanvas()
        .appendChild(this.createDom_(b, !(!e || !f)));
...
Blockly.Bubble.prototype.createDom_ = function (a, b) {
    ...
    -1 != goog.userAgent.getUserAgentString()
        .indexOf('JavaFX') && (c = {});
...
Blockly.Icon.prototype.createIcon = function () {
    this.iconGroup_ || (this.iconGroup_ = Blockly.utils.createSvgElement('g', {'class': 'blocklyIconGroup'}, null), this.block_.isInFlyout && Blockly.utils.addClass(this.iconGroup_, 'blocklyIconGroupReadonly'), this.drawIcon_(this.iconGroup_), this.block_.getSvgRoot()
        .appendChild(this.iconGroup_), Blockly.bindEventWithChecks_(this.iconGroup_, 'mouseup', this, this.iconClick_), this.updateEditable());
};
...
Blockly.Connection.prototype.isConnectionAllowed = function (a) {
    ...
    return a.type == Blockly.INPUT_VALUE && a.isConnected() && !a.targetBlock()
        .isMovable() && !a.targetBlock()
        .isShadow() || this.type == Blockly.PREVIOUS_STATEMENT && a.isConnected() && !this.sourceBlock_.nextConnection && !a.targetBlock()
        .isShadow() && a.targetBlock().nextConnection ||
...
Blockly.Extensions.buildTooltipWithFieldValue = function (a, b) {
    ...
    return function () {
        this.setTooltip(function () {
            return Blockly.utils.replaceMessageReferences(a)
...
Blockly.DraggedConnectionManager.prototype.applyConnections = function () {
    this.closestConnection_ && (this.localConnection_.connect(this.closestConnection_), this.topBlock_.rendered && ((this.localConnection_.isSuperior() ? this.closestConnection_ : this.localConnection_).getSourceBlock()
        .connectionUiEffect(), this.topBlock_.getRootBlock()
        .bringToFront()), this.removeHighlighting_());
};
...
Blockly.Gesture.prototype.doBlockClick_ = function () {
    this.flyout_ && this.flyout_.autoClose ? this.targetBlock_.disabled || (Blockly.Events.getGroup() || Blockly.Events.setGroup(!0), this.flyout_.createBlock(this.targetBlock_)
        .scheduleSnapAndBump()) : Blockly.Events.fire(new Blockly.Events.Ui(this.startBlock_, 'click', void 0, void 0));
    this.bringBlockToFront_();
    Blockly.Events.setGroup(!1);
};
...
Blockly.FieldLabel.prototype.init = function () {
    ...
    }, null), this.class_ && Blockly.utils.addClass(this.textElement_, this.class_), this.visible_ || (this.textElement_.style.display = 'none'), this.sourceBlock_.getSvgRoot()
        .appendChild(this.textElement_), this.textElement_.tooltip = this.sourceBlock_, Blockly.Tooltip.bindMouseEvents(this.textElement_), this.render_());
};
...
Blockly.Options = function (a) {
    var b = !!a.readOnly;
    if (b) {
        var c = null, d = !1, e = !1, f = !1, g = !1, h = !1,
            k = !1;
    } else {
...
Blockly.WorkspaceAudio.prototype.play = function (a, b) {
    ...
    if (c) {
        ...
        this.parentWorkspace_ && this.parentWorkspace_.getAudioManager()
            .play(a, b);
    }
};
...
Blockly.WorkspaceSvg.prototype.setupDragSurface = function () {
    if (this.useWorkspaceDragSurface_ && !this.isDragSurfaceActive_) {
        ...
        var a = this.svgBlockCanvas_.previousSibling, b = this.getParentSvg()
            .getAttribute('width'), c = this.getParentSvg()
            .getAttribute('height'), d = Blockly.utils.getRelativeXY(this.svgBlockCanvas_);
...
Blockly.WorkspaceSvg.prototype.setVisible = function (a) {
    ...
    this.getFlyout_() && this.getFlyout_()
...
Blockly.WorkspaceSvg.prototype.zoom = function (a, b, c) {
    var d = this.options.zoomOptions.scaleSpeed, e = this.getMetrics(), f = this.getParentSvg()
        .createSVGPoint();
    f.x = a;
    f.y = b;
    f = f.matrixTransform(this.getCanvas()
        .getCTM()
        .inverse());
    a = f.x;
    b = f.y;
    ...
    this.scale != c && (this.scrollbar && (a = f.getCTM()
        .translate(a *
            (1 - d), b * (1 - d))
        .scale(d), this.scrollX = a.e - e.absoluteLeft, this.scrollY = a.f - e.absoluteTop), this.setScale(c));
};
...
Blockly.Mutator.prototype.resizeBubble_ = function () {
    var a = 2 * Blockly.Bubble.BORDER_WIDTH, b = this.workspace_.getCanvas()
        .getBBox();
    ...
    this.block_.RTL && (a = 'translate(' + this.workspaceWidth_ + ',0)', this.workspace_.getCanvas()
...
Blockly.BlockSvg.prototype.initSvg = function () {
    ...
    this.eventsInit_ = !0;
    this.getSvgRoot().parentNode || this.workspace.getCanvas()
...
Blockly.BlockSvg.prototype.setParent = function (a) {
    if (a != this.parentBlock_) {
        ...
        Blockly.Field.stopCache();
        a && (c = this.getRelativeToSurfaceXY(), a.getSvgRoot()
...
Blockly.BlockSvg.prototype.disposeUiEffect = function () {
    this.workspace.getAudioManager()
        .play('delete');
    ...
    if (this.workspace && !this.workspace.isDragging()) {
        ...
        if (!a.isInFlyout) {
            for (var b = this.getConnections_(!1), c = 0, d; d = b[c]; c++) {
                d.isConnected() && d.isSuperior() && d.targetBlock()
                    .bumpNeighbours_();
                for (var e = d.neighbours_(Blockly.SNAP_RADIUS), f = 0, g; g = e[f]; f++) {
                    d.isConnected() && g.isConnected() || g.getSourceBlock()
    ...
    for (var d = 0, e = 0, f = !1, g = !1, h = !1, k = void 0, n = this.getInputsInline() && !this.isCollapsed(), p = 0, l; l = b[p]; p++) {
        if (l.isVisible()) {
            ...
            if (l.connection && l.connection.isConnected()) {
                var q = l.connection.targetBlock()
                    .getHeightWidth();
    ...
    for (var g, h = 0, k, n, p = 0, l; l = e[p]; p++) {
        ...
        if (this.isCollapsed()) {
            ...
            l.type == Blockly.INPUT_VALUE ? (m = l[0], k = h, m.align != Blockly.ALIGN_LEFT && (q = e.rightEdge - m.fieldWidth - Blockly.BlockSvg.TAB_WIDTH - 2 * Blockly.BlockSvg.SEP_SPACE_X, m.align == Blockly.ALIGN_RIGHT ? g += q : m.align == Blockly.ALIGN_CENTRE && (g += q / 2)), this.renderFields_(m.fieldRow, g, k), a.push(Blockly.BlockSvg.TAB_PATH_DOWN), q = l.height - Blockly.BlockSvg.TAB_HEIGHT, a.push('v', q), this.RTL ? (b.push(Blockly.BlockSvg.TAB_PATH_DOWN_HIGHLIGHT_RTL), b.push('v',
                q + .5)) : (b.push('M', e.rightEdge - 5 + ',' + (h + Blockly.BlockSvg.TAB_HEIGHT - .7)), b.push('l', .46 * Blockly.BlockSvg.TAB_WIDTH + ',-2.1')), k = this.RTL ? -e.rightEdge - 1 : e.rightEdge + 1, m.connection.setOffsetInBlock(k, h), m.connection.isConnected() && (this.width = Math.max(this.width, e.rightEdge + m.connection.targetBlock()
                .getHeightWidth().width - Blockly.BlockSvg.TAB_WIDTH + 1))) : l.type == Blockly.DUMMY_INPUT ? (m = l[0], k = h, m.align != Blockly.ALIGN_LEFT && (q = e.rightEdge - m.fieldWidth - 2 * Blockly.BlockSvg.SEP_SPACE_X, e.hasValue && (q -= Blockly.BlockSvg.TAB_WIDTH),
...
Blockly.Events.Move.prototype.currentLocation_ = function () {
    var a = Blockly.Workspace.getById(this.workspaceId)
        .getBlockById(this.blockId), b = {}, c = a.getParent();
    if (c) {
...
Blockly.FieldDropdown.prototype.addTouchStartListener_ = function (a) {
    a.getHandler()
        .listen(a.getElement(), goog.events.EventType.TOUCHSTART, function (a) {
            this.getOwnerControl(a.target)
                .handleMouseDown(a);
        });
};
Blockly.FieldDropdown.prototype.addTouchEndListener_ = function (a) {
    a.getHandler()
        .listen(a.getElement(), goog.events.EventType.TOUCHEND, function (a) {
            this.getOwnerControl(a.target)
                .performActionInternal(a);
        });
};
...
Blockly.FieldImage.prototype.init = function () {
    ...
    }, this.fieldGroup_), this.setValue(this.src_), this.sourceBlock_.getSvgRoot()
        .appendChild(this.fieldGroup_), this.setTooltip(this.sourceBlock_), Blockly.Tooltip.bindMouseEvents(this.imageElement_), this.maybeAddClickHandler_());
};
    ...
    var d = function (e) {
        Blockly.Variables.promptName(Blockly.Msg.RENAME_VARIABLE_TITLE.replace('%1', b.name), e, function (e) {
            if (e) {
                ...
                f && f.type != b.type ? Blockly.alert(Blockly.Msg.VARIABLE_ALREADY_EXISTS_FOR_ANOTHER_TYPE.replace('%1', e.toLowerCase())
                    .replace('%2', f.type), function () {
                    d(e);
...
Blockly.Variables.promptName = function (a, b, c) {
    Blockly.prompt(a, b, function (a) {
        a && (a = a.replace(/[\s\xa0]+/g, ' ')
            .replace(/^ | $/g, ''), a == Blockly.Msg.RENAME_VARIABLE || a == Blockly.Msg.NEW_VARIABLE) && (a = null);
        c(a);
    });
};
...
Blockly.Flyout.prototype.placeNewBlock_ = function (a) {
    ...
    b = goog.math.Coordinate.difference(a, d)
        .scale(1 / b.scale);
    c.moveBy(b.x,
        b.y);
    return c;
...
Blockly.HorizontalFlyout.prototype.getMetrics_ = function () {
    ...
    try {
        var a = this.workspace_.getCanvas()
            .getBBox();
    } catch (e) {
...
Blockly.createDom_ = function (a, b) {
    ...
    var c = Blockly.utils.createSvgElement('svg', {
        ...
        version: '1.1',
        'class': 'blocklySvg'
    }, a), d = Blockly.utils.createSvgElement('defs', {}, c), e = String(Math.random())
        .substring(2), f = Blockly.utils.createSvgElement('filter', {
